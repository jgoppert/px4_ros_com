...
if [[ $1 == "-h" ]] || [[ $1 == "--help" ]]; then
  ...
  echo -e "\t--ros2_distro \t\t Set ROS 2 distro name (dashing|eloquent|foxy|galactic|rolling|humble). If not set, the script will set the ROS_DISTRO env variable based on the Ubuntu codename"
